...
const char* ssid = "VIET ANH"; // Enter your network name

const char* password = "hoanganh"; // Enter your network password
...
void setup() {
  ...
  Serial.begin(9600); // Define serial communication with baud rate of 115200
